...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve shooting, dribbling, and defensive skills in a fun team setting",
    ...
    "Art Studio": {
        "description": "Create drawings, paintings, and mixed-media artwork with guided instruction",
